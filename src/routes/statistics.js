...
/**
 * @swagger
 * /api/Statistics/statisticsForTeacher:
 *   post:
 *     summary: Get statistics for all students in mosque (teacher only)
 *     tags: [Statistics]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
router.post('/statisticsForTeacher',authMiddleware,teacherOnly,statisticsForTeacher);
