...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const rolePermissions = [
      ...
      {role_id: 3,  permission_id: 12} ,  //view_complaint_history
      { role_id: 3, permission_id: 7 }, // citizen_update_complaint
      { role_id: 3, permission_id: 14 }, // citizen_view_complaint_Id
      ...
      {role_id: 2, permission_id: 15} ,   //delete_complaint
      ...
      {role_id: 1, permission_id: 15}  ,    //delete_complaint
      {role_id: 1, permission_id: 16}  ,    //get_all_users
